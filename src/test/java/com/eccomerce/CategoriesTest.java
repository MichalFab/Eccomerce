...
import com.eccomerce.pom.CategoriesPOM;
...
public class CategoriesTest extends FluentTest {
    private PhantomJSDriver webDriver = new PhantomJSDriver();
    private CategoriesPOM categoriesPOM = new CategoriesPOM(webDriver);
    @BeforeClass
    ...
    public void testNumberOfCategories() {
       ...
       assertThat(categoriesPOM.getNumberOfCategories()).isEqualTo(3);
    }
